...
impl From<BaseKeymapContent> for BaseKeymap {
    fn from(value: BaseKeymapContent) -> Self {
        match value {
            ...
            BaseKeymapContent::Eclipse => Self::Eclipse,
...
impl Into<BaseKeymapContent> for BaseKeymap {
    fn into(self) -> BaseKeymapContent {
        match self {
            ...
            BaseKeymap::Eclipse => BaseKeymapContent::Eclipse,
...
impl Display for BaseKeymap {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            BaseKeymap::Eclipse => write!(f, "Eclipse (beta)"),
...
impl BaseKeymap {
    ...
    pub fn asset_path(&self) -> Option<&'static str> {
        ...
        match self {
            ...
            BaseKeymap::Eclipse => Some("keymaps/macos/eclipse.json"),
        ...
        match self {
            ...
            BaseKeymap::Eclipse => Some("keymaps/linux/eclipse.json"),
